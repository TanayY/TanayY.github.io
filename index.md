...
- **Freelance Data Scientist at Krios (Client: Mahindra Powerol)**
  ...
  - Led data collection and feature engineering to boost model performance.
  
- **Associate Data Scientist at Opentext**
  - Implemented advanced ML algorithms for invoice management, increasing processing efficiency by 50%.
  - Built predictive models to enhance vendor reliability and decision-making.
...
- **GitHub:** [github.com/TanayY](https://github.com/TanayY)
...
<head>
    ...
    <title>Tanay Yeole - Data Scientist</title>
    ...
    <style>
        ...
        :root {
            ...
            --primary-color-light: #5ad1e6; /* Soft blue-cyan */
            --accent-color: #3ec6e0; /* Modern blue-cyan */
            --accent-color-light: #3ec6e0; /* Same for light theme for consistency */
            --gradient-1: linear-gradient(90deg, #7f5af0 0%, #3ec6e0 100%);
            --gradient-1-light: linear-gradient(90deg, #5ad1e6 0%, #3ec6e0 100%);
            --gradient-2: linear-gradient(135deg, #7f5af0 0%, #3ec6e0 100%);
            --gradient-2-light: linear-gradient(135deg, #a6c1ee 0%, #3ec6e0 100%);
            --gradient-3: linear-gradient(225deg, #232946 0%, #7f5af0 100%);
            --gradient-3-light: linear-gradient(225deg, #f7f8fa 0%, #5ad1e6 100%);
            --card-bg: rgba(36, 37, 46, 0.7);
            ...
            --shadow-light: 0 8px 32px 0 rgba(90, 209, 230, 0.12);
        }
    ...
    <section class="section fade-in" id="dashboard">
        ...
        <div class="dashboard-section">
            ...
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                <img src="third.gif" alt="Sales & Inquiry Forecasting Dashboard Demo" style="max-width: 100%; border-radius: 18px; box-shadow: 0 4px 24px rgba(62,198,224,0.12); margin-bottom: 2rem; background: #fff;">
